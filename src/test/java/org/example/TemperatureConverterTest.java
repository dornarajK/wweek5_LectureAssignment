...
class TemperatureConverterTest {
    ...
    void testKelvinToCelsius() {
        Assertions.assertEquals(-273.15, converter.kelvinToCelsius(0), 0.001);
        Assertions.assertEquals(0.0, converter.kelvinToCelsius(273.15), 0.001);
        Assertions.assertEquals(100.0, converter.kelvinToCelsius(373.15), 0.001);
    }
